...
public class Application {
    ...
    public static final String ROOT = File.separator + "home" + File.separator + "joao" + File.separator + "Desktop" + File.separator + "utfpr" + File.separator + "JAVA 2" + File.separator + "bloco 2" + File.separator + "hd";
    ...
    private void executar() {
        ...
        while (!stop) {
            ...
            } catch (UnsupportedOperationException | ArrayIndexOutOfBoundsException | IOException ex ) {
